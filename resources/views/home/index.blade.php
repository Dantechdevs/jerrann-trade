...
@section('title', 'Jerann Traders – Printers, Laptops & Repair Services')
...
<div class="hero">
    ...
    <div class="hero-btns">
        <a href="{{ route('products.index') }}" class="btn-hero-primary">Shop Now</a>
        <a href="{{ route('repairs.create') }}" class="btn-hero-outline">Book a Repair</a>
    </div>
</div>

<!-- ══ CATEGORY STATS BAR ══ -->
<div class="cat-stats">
    <a href="{{ route('products.index', ['category'=>'printers']) }}" class="cat-stat">
        <div class="cat-stat-name">Printers</div>
        <div class="cat-stat-count">{{ \App\Models\Product::whereHas('category', fn($q)=>$q->where('slug','printers'))->count() }} Products</div>
    </a>
    <a href="{{ route('products.index', ['category'=>'inks']) }}" class="cat-stat">
        <div class="cat-stat-name">Toners</div>
        <div class="cat-stat-count">{{ \App\Models\Product::whereHas('category', fn($q)=>$q->where('slug','inks'))->count() }} Products</div>
    </a>
    <a href="{{ route('products.index', ['category'=>'laptops']) }}" class="cat-stat">
        <div class="cat-stat-name">Laptops</div>
        <div class="cat-stat-count">{{ \App\Models\Product::whereHas('category', fn($q)=>$q->where('slug','laptops'))->count() }} Products</div>
    </a>
    <a href="{{ route('products.index', ['category'=>'accessories']) }}" class="cat-stat">
        <div class="cat-stat-name">Spare Parts</div>
        <div class="cat-stat-count">{{ \App\Models\Product::whereHas('category', fn($q)=>$q->where('slug','accessories'))->count() }} Products</div>
    </a>
</div>
...
<div class="container">
    ...
    <div class="section-wrap">
        ...
        <div class="products-5col">
            @forelse($printers as $product)
            @include('home._pcard', ['product'=>$product, 'hot'=>true])
            @empty
            @for($i=0;$i<5;$i++)
        ...
        <a href="{{ route('products.index', ['category'=>'printers']) }}" class="view-all-btn">VIEW ALL PRINTERS ➜</a>
    </div>
    ...
    <div class="section-wrap" style="padding-top:0;">
        ...
        <div class="section-underline"></div>
        <div class="products-5col">
            @forelse($newIn as $product)
            @include('home._pcard', ['product'=>$product, 'new'=>true])
            @empty
            @for($i=0;$i<5;$i++)
    ...
    <div class="section-wrap" style="padding-top:0;">
        ...
        <div class="section-layout">
            <div class="section-banner" style="background:#1a7a2e;">
                <img src="{{ asset('images/banners/banner-printers.png') }}" alt="Printers Banner">
                <div class="section-banner-overlay">
                    ...
                    <a href="{{ route('products.index', ['category'=>'printers']) }}" style="display:inline-block;margin-top:0.8rem;border:2px solid #fff;color:#fff;padding:0.4rem 1.2rem;border-radius:4px;font-size:0.8rem;font-weight:700;">SHOP NOW ➜</a>
                </div>
            </div>
            <div class="section-products">
                @forelse($printers->take(8) as $product)
                @include('home._pcard', ['product'=>$product, 'hot'=>true])
                @empty
                @for($i=0;$i<4;$i++)
    ...
    <div class="section-wrap" style="padding-top:0;">
        ...
        <div class="section-layout">
            <div class="section-banner" style="background:#c8956c;">
                <img src="{{ asset('images/banners/banner-toners.png') }}" alt="Toners Banner">
                <div class="section-banner-overlay">
                    ...
                    <a href="{{ route('products.index', ['category'=>'inks']) }}" style="display:inline-block;margin-top:0.8rem;border:2px solid #fff;color:#fff;padding:0.4rem 1.2rem;border-radius:4px;font-size:0.8rem;font-weight:700;">SHOP NOW ➜</a>
                </div>
            </div>
            <div class="section-products">
                @forelse($toners as $product)
                @include('home._pcard', ['product'=>$product])
                @empty
                @for($i=0;$i<4;$i++)
    ...
    <div class="section-wrap" style="padding-top:0;">
        ...
        <a href="{{ route('products.index', ['category'=>'laptops']) }}" class="view-all-btn">VIEW ALL COMPUTERS ➜</a>
    </div>
    ...
    <div class="section-wrap" style="padding-top:0;">
        ...
        <div class="section-layout">
            <div class="section-banner" style="background:#7ec8c0;">
                <img src="{{ asset('images/banners/banner-spares.png') }}" alt="Spares Banner">
                <div class="section-banner-overlay">
                    ...
                    <a href="{{ route('products.index', ['category'=>'accessories']) }}" style="display:inline-block;margin-top:0.8rem;border:2px solid #fff;color:#fff;padding:0.4rem 1.2rem;border-radius:4px;font-size:0.8rem;font-weight:700;">SHOP NOW ➜</a>
                </div>
            </div>
            <div class="section-products">
                @forelse($spares as $product)
                @include('home._pcard', ['product'=>$product])
                @empty
                @for($i=0;$i<4;$i++)
    ...
    <div class="faq-section">
        ...
        <div class="faq-layout">
            <div class="faq-img"><img src="{{ asset('images/banners/faq-illustration.png') }}" alt="FAQ" style="width:100%;max-width:260px;"></div>
            <div>
                @foreach([
    ...
    <div class="brands-section">
        <div class="brands-layout">
            ...
            <div class="brands-grid">
                @foreach(['Xerox','Toshiba','Sharp','HP','Canon','Konica Minolta','Kyocera','Ricoh','Epson','Brother','Samsung','Panasonic'] as $brand)
                <a href="{{ route('products.index', ['search'=>$brand]) }}" class="brand-cell">{{ $brand }}</a>
                @endforeach
            </div>
        </div>
    </div>
