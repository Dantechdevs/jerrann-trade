...
<nav class="navbar">
    ...
    <div class="nav-links">
        ...
        <a href="<?php echo e(route('repairs.create')); ?>" class="nav-link <?php echo e(request()->routeIs('about*') ? 'active' : ''); ?>">About Us</a>
        <a href="#"                             class="nav-link <?php echo e(request()->routeIs('blog*') ? 'active' : ''); ?>">Blog</a>
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->user()->isAdmin()): ?>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link" style="color:#ffd54f;">
    ...
    <div class="searchbar-right">
        ...
        <a href="<?php echo e(auth()->check() ? route('cart.index') : route('login')); ?>" class="searchbar-icon-group">
            <div class="icon">
                ...
                <span class="searchbar-count"><?php echo e($cartCount); ?></span>
            </div>
            <span>KSH <?php echo e(number_format($cartTotal)); ?></span>
        </a>
    </div>
</div>
...
<div class="container page-content">
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-error"><i class="fa-solid fa-circle-xmark"></i> <?php echo e(session('error')); ?></div>
    <?php endif; ?>
