...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Jerann Traders'); ?> – Printers, Laptops & Repair Services</title>
    <style>
        /* ── Reset & Base ── */
...
<div class="topbar">
    <div class="topbar-left">
        <a href="<?php echo e(route('repairs.create')); ?>">📞 Contact Us</a>
        <a href="#">FAQs</a>
...
<nav class="navbar">
    <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Jerann Traders Logo">
        <div>
    ...
    <div class="nav-links">
        ...
        <a href="<?php echo e(route('products.index')); ?>" class="nav-link <?php echo e(request()->routeIs('products*') ? 'active' : ''); ?>">Shop</a>
        <a href="<?php echo e(route('repairs.create')); ?>" class="nav-link <?php echo e(request()->routeIs('repairs*') ? 'active' : ''); ?>">About Us</a>
        <a href="<?php echo e(route('repairs.create')); ?>" class="nav-link">Contact Us</a>
        <a href="<?php echo e(route('repairs.create')); ?>" class="nav-link nav-link-highlight">Request For Quotation</a>
        <a href="<?php echo e(route('repairs.create')); ?>" class="nav-link">Request For Service</a>
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->user()->isAdmin()): ?>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link" style="color:#ffd54f;">⚙ Admin</a>
            <?php endif; ?>
        <?php endif; ?>
    </div>
</nav>
...
<!-- ══ LAYER 3: Search Bar ══ -->
<div class="searchbar">
    <form class="searchbar-form" action="<?php echo e(route('products.index')); ?>" method="GET">
        <input type="text" name="search" class="searchbar-input"
               placeholder="Search for products..."
               value="<?php echo e(request('search')); ?>">
        <select name="category" class="searchbar-select">
            <option value="">Select Category</option>
            <option value="printers"     <?php echo e(request('category') == 'printers'     ? 'selected' : ''); ?>>Printers</option>
            <option value="laptops"      <?php echo e(request('category') == 'laptops'      ? 'selected' : ''); ?>>Laptops</option>
            <option value="tablets"      <?php echo e(request('category') == 'tablets'      ? 'selected' : ''); ?>>Tablets</option>
            <option value="inks"         <?php echo e(request('category') == 'inks'         ? 'selected' : ''); ?>>Toner & Inks</option>
            <option value="accessories"  <?php echo e(request('category') == 'accessories'  ? 'selected' : ''); ?>>Accessories</option>
        </select>
    ...
    <div class="searchbar-right">
        ...
        <a href="<?php echo e(auth()->check() ? route('cart.index') : route('login')); ?>" class="searchbar-icon-group">
            <div class="icon">🛒<span class="searchbar-count"><?php echo e($cartCount); ?></span></div>
            <span>KSH <?php echo e(auth()->check() ? number_format(\App\Models\CartItem::where('user_id', auth()->id())->join('products','cart_items.product_id','=','products.id')->sum(\Illuminate\Support\Facades\DB::raw('cart_items.quantity * products.price'))) : '0'); ?></span>
        </a>
    </div>
</div>
...
<div class="footer-main">
    <div class="footer-col">
        ...
        <ul>
            ...
            <li><a href="<?php echo e(route('repairs.create')); ?>">Request For Service</a></li>
    ...
    <div class="footer-col">
        ...
        <ul>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">All Printers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">Kyocera Printers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">HP Printers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">Canon Printers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">Epson Printers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'printers'])); ?>">Brother Printers</a></li>
        </ul>
    </div>
    ...
    <div class="footer-col">
        ...
        <ul>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">Kyocera Toners</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">Ricoh Toners</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">HP Toners</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">Xerox Toners</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">Canon Toners</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'inks'])); ?>">Epson Inks</a></li>
        </ul>
    </div>
    ...
    <div class="footer-col">
        ...
        <ul>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">Drum Units</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">Fuser Units</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">OPC Drums</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">Rollers</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">Fuser Films</a></li>
            <li><a href="<?php echo e(route('products.index', ['category' => 'accessories'])); ?>">Developers</a></li>
        </ul>
    </div>
    ...
    <div class="footer-col">
        ...
        <div class="footer-till">
            <?php $__currentLoopData = str_split('522522'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="footer-bottom">
    &copy; <?php echo e(date('Y')); ?> <strong>Jerann Traders</strong> — All Rights Reserved &nbsp;|&nbsp;
    Developed by <a href="https://ngwasidaniel.vercel.app/" target="_blank" rel="noopener">Dantechdevs</a>
</div>

<?php echo $__env->yieldContent('scripts'); ?>
</body>
</html><?php /**PATH C:\xampp\htdocs\jerann-traders\resources\views/layouts/app.blade.php ENDPATH**/ ?>